...
Lang.Ru: [
    ...
    Re(r'(|отъ?|вы|до|за|у|про)[еёë]б(а?нут|ан+)(ый?|ая?|ые|ого|ому?|ой?|ую?|ых|ыми?|ых|учка|)', 50,
    ...
    Re(r'(у|по)мр(и|ите?|[еёë]шь?|ут|ете?|[ёë]те?)', 40,
    ...
    Re(r'убейся', 80,
       ban=-2, reason=Reason.Offensive, info="убейся"),
