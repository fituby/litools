...
Lang.En: [
    ...
    Re(r'^(kill|murder)\s((yo)?[uy]r\s?(self|famil[yi]|m[ou]m|mother)(\sand\s)?)+', 90, is_separate_word=False,
       reason=Reason.Offensive, ban=-1, info="Critical: Kill yourself"),
    Re(r'(hang|ne[ck]+|kill|murder)\s((yo)?[uy]r\s?(self|family)(\sand\s)?)+', 90,
    ...
    Re(r'(f{1,20}|ph)(u|a|e){1,20}c?k+(ers?|rs?|u|t|ing?|ign|en|e?d|tard?s?|face|of+|)', 15,
    ...
    Re(r'(kill|murder|hang|ne[ck]+)\smy\s?self', 30,
    ...
    Re(r'ch(e{1,20}a?|i{1,20})t+(ing?|ign|er{1,20}s?|e?d|s?|ah{1,20}|)', exclude_tournaments=[TournType.Study],
    ...
    Re(r'co[ck]+(su[ck]+(ers?|ing?|ign|e?d)|)', 50,
    ...
    Re(r'fu?[ck]+(e?d|e?r|r|k|t|ing?|ign|tard?|face|of+)',
    ...
    Re(r'sandbag+(er+|ing?|ign|e?d+|)', 20,
    ...
    Re(r'shi?t+(z|e|y|bag|ed|s|en|ing?|ign|)', 5,
    ...
    Re(r'we+a+k', 5, exclude_tournaments=[TournType.Study],
...
Lang.Ru: [
    ...
    Re(r'д[ао]лб[ао][еёë]б(ин|)(ам?|у|е|ом|ы|ов|ами?|ах|ой|)', 50,
...
Lang.Tr: [
    ...
    Re(r'((an+an[iı](z[iı])?)|(kar[iı]n[iı](z[iı])?)|(avrad[iı]n[iı](z[iı])?)|(bac[ıi]n[iı](z[iı])?)) (s[ii̇]k[ei](yim|cem|rim|m))',
        reason=Reason.Offensive, info="annanı sikeyim"),
    Re(r'((an+an(a|[iı]za))|(kar[iı]n(a|[iı]za))|(avrad[iı]n(a|[iı]za))|(bac[ıi]n(a|[iı]za))) ((koya(y[iı]m|m))|(soka(y[iı]m|m))|([cç]aka(y[iı]m|m)))',
        reason=Reason.Offensive, info="annanı sikeyim"),
    Re(r'aptal',
