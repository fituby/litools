...
Lang.Ru: [
    ...
    Re(r'в?п[ие]зд(ам?|ы|е|у|ой|ами|ах|)', 30,
    ...
    Re(r'(|отъ?|вы|до|за|у|про|съ?|на)[её]ба?(|ну)(ла?|ли|ло|ли|ть?|)(|с(|ь|ъ|я))', 50,
       reason=Reason.Offensive, info="заебал"),
    Re(r'(|отъ?|вы|до|за|у|про|съ?)[её]баль?ник(а|у|ом|е|и|ов|ами?|ах|)', 40,
    ...
    Re(r'(|отъ?|вы|до|за|у|про)[её]б(а?нут|ан+)(ый?|ая?|ые|ого|ому?|ой?|ую?|ых|ыми?|ых|учка|)', 50,
       ban=-3, reason=Reason.Offensive, info="ёбнутый"),
    Re(r'(|от(|ъ|ь)|вы|до|за|у|про|с(|ъ|ь))(е|ё)б(аш|)(уть|ут?|и|ите?|ишь?|им|ым|ыте?|ышь?|ать?|[её]шь?|[её]т|[её]м|[её]те)(|с(|ь|ъ|я))', 40,
...
Lang.Spam: [
    ...
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/@\/[-a-zA-Z0-9@:%._\+~#=]{0,30}', 0, class_name="text-success",
           reason=Reason.No),
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/[-a-zA-Z0-9@:%._\+~#=]{0,40}', 0, class_name="text-success",
           reason=Reason.No),
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/variant\/?[-a-zA-Z0-9@:%._\+~#=]{0,20}', 0, class_name="text-success",
           reason=Reason.No),
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/page\/?[-a-zA-Z0-9@:%._\+~#=]{0,40}', 0, class_name="text-success",
           reason=Reason.No),
    ReLink(r'https?:\/\/(www\.)?lichess\.thijs\.com\/[-a-zA-Z0-9@:%._\+~#=\/]{0,80}', 0, class_name="text-success",
           reason=Reason.No),
    ReLink(r'^https?:\/\/(www\.)?lichess\.org\/racer\/[-a-zA-Z0-9@:%._\+~#=]{5,8}$', 60, is_separate_word=False,
           ban=-1, reason=Reason.Spam, info="[link] racer"),
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/racer\/[-a-zA-Z0-9@:%._\+~#=]{5,8}', 50,
    ...
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)55DLs_7VJNE', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)oHg5SJYRHA0', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)lNv3pcPVhlY', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)lpiB2wMc49g', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)iik25wqIuFo', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)xvFZjo5PgG0', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)j8PxqgliIno', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)PyoRdu-i0AQ', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)HIcSWuKMwOw', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)g7YjojDbJGY', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)p7YXXieghto', 60,
           ban=-1, reason=Reason.Spam, info="[link] Rickrolling"),
    ReLink(r'(https?:\/\/|)(www\.)?youtu(be\.com\/watch\?v=|\.be\/)RoozSjudh0I', 60,
           ban=-1, reason=Reason.Spam, info="[link] Spam"),
    ReLink(r'https?:\/\/(www\.)?(youtu|youtube|twitch|instagram)[-a-zA-Z0-9@:%._\+~#=]{0,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)', 40,
           reason=Reason.Spam, info="Link"),
    ReLink(r'https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)', 10,
           reason=Reason.Spam, info="Link"),
    # Spam
