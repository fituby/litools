...
Lang.Spam: [
    ...
    ReLink(r'https?:\/\/(www\.)?lichess\.org\/streamer\/[-\w@:%\.\+~#=]{5,8}', 40,
    ...
    ReLink(r'https?:\/\/(www\.)?[-\w@:%\.\+~#=]+\.\w{1,6}\b[-\w\(\)@:%\+\.~#\?&\/=]*', 10,
           reason=Reason.Spam, info="Link"),
    # Spam
