...
## Sandbag/Boost
The tool scans the last 100 games of the player whose name is entered in the top field (or less if the player hasn't played that many games since the previous warning), and shows the results, highlighting important information if necessary.
